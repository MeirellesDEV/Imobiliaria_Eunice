...
<form id="adicionar-casa-container" class="add-layout" action="cadastrar" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <input type="number" name="qtd_banheiros" min="0" max="20" value="1" id="sliderBanheiro" class="add-input">
    ...
    <input type="number" name="qtdGaragemNaoCobertas" min="0" max="20" value="1" id="sliderVagasNaoCoberto" class="add-input">

    <p id="qtd-salas-label" class="slider-label">Quantidade de Salas:</p>
    <input type="number" name="qtdSalas" min="0" max="20" value="1" id="sliderSalas" class="add-input">

    <p id="qtd-dorms-label" class="slider-label">Quantidade de Dormitórios:</p>
    <input type="number" name="qtdDorms" min="0" max="20" value="1" id="sliderDorms" class="add-input">
    ...
    <input type="text" name="valorAluguel" id="valor-aluguel" class="add-input input-format" step=".01" lang="pt-BR" placeholder="Valor de aluguel" style="margin-top:10px">

    <input type="number" name="valorVenda" id="valor-venda" class="add-input input-format" step=".01" lang="pt-BR" placeholder="Valor de venda" style="margin-top:10px">
    ...
    <div class="checkbox">
        ...
        <div class="check-item">
            <input type="checkbox" name="agua" id="agua"><label for="agua">Água</label>
        </div>
        <div class="check-item">
            <input type="checkbox" name="energia" id="energia"><label for="energia">Energia</label>
        </div>
        <div class="check-item">
            <input type="checkbox" name="mesanino" id="mesanino"><label for="mesanino">Mezanino</label>
        </div>
        <div class="check-item">
        ...
        <div class="check-item">
            <input type="checkbox" name="geradorEnergiaImovel" id="geradorEnergiaImovel"><label for="geradorEnergiaImovel">Gerador de energia</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="sisAlar" id="sisAlar"><label for="sisAlar">Sistema de alarme</label>
        </div>
        <div class="check-item">
            <input type="checkbox" name="sisTel" id="sisTel"><label for="sisTel">Sistema de telefonia</label>
        </div>
        <div class="check-item">
            <input type="checkbox" name="rede" id="rede"><label for="rede">Estrut. rede. comput.</label>
        </div>
        <div class="check-item">
            <input type="checkbox" name="acessoDeficiente" id="acessoDeficiente"><label for="acessoDeficiente">Acesso para deficientes</label>
        </div>
        <div class="check-item">
        ...
        <div class="check-item">
            <input type="checkbox" name="banheiroEmpregada" id="banheiroEmpregada"><label for="banheiroEmpregada">Wc. de empregados</label>
        </div>
        <div class="check-item">
        ...
        <div class="check-item">
            <input type="checkbox" name="suiteMaster" id="suiteMaster"><label for="suiteMaster">Suíte Master</label>
        </div>
        <div class="check-item">
        ...
        <div class="check-item">
            <input type="checkbox" name="aguaSolar" id="aguaSolar"><label for="aguaSolar">Aq. água c/ energia solar</label>
        </div>
        ...
        <div class="check-item">
            <input type="checkbox" name="depEmpregados" id="depEmpregados"><label for="depEmpregados">Dep. de empregados</label>
        </div>
        ...
        <div class="check-item">
            <input type="checkbox" name="piscinaCondominio" id="piscinaCondominio"><label for="piscinaCondominio">Piscina</label>
        </div>
        ...
        <div class="check-item">
            <input type="checkbox" name="pisoBioquete" id="pisoBioquete"><label for="pisoBioquete">Piso Bloquete</label>
        </div>
        ...
        <div class="check-item">
            <input type="checkbox" name="contraPiso" id="contraPiso"><label for="contraPiso">Contrapiso</label>
        </div>
        ...
        <div class="check-item">
            <input type="checkbox" name="armarioCozinha" id="armarioCozinha"><label for="armarioCozinha">Armários na Cozinha</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="armarioCorredor" id="armarioCorredor"><label for="armarioCorredor">Armários no Corredor</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="armarioCloset" id="armarioCloset"><label for="armarioCloset">Armários no Closet</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="armarioQuarto" id="armarioQuarto"><label for="armarioQuarto">Armários no Quarto</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="armarioBanheiro" id="armarioBanheiro"><label for="armarioBanheiro">Armários no Banheiro</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="armarioSala" id="armarioSala"><label for="armarioSala">Armários na Sala</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="armarioEscritorio" id="armarioEscritorio"><label for="armarioEscritorio">Armários no Escritório</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="armarioDepEmp" id="armarioDepEmp"><label for="armarioDepEmp">Armários Dep. Empregado</label>
        </div>

        <div class="check-item">
            <input type="checkbox" name="armarioAreaServico" id="armarioAreaServico"><label for="armarioAreaServico">Armários Área de Serviço</label>
        </div>
        ...
        <div class="check-item">
            <input type="checkbox" name="luminarias" id="luminarias"><label for="luminarias">Luminárias</label>
        </div>
    ...
    <div class="checkbox">
        <div class="check-item">
            <input type="checkbox" name="arCondicionadoCentral" id="arCondicionadoCentral"><label for="arCondicionadoCentral">Ar Condicionado central</label>
        </div>
        <div class="check-item">
        ...
        <div class="check-item">
            <input type="checkbox" name="quadra" id="quadra"><label for="quadra">Quadra poliesportiva</label>
        </div>
        <div class="check-item">
        ...
        <div class="check-item">
            <input type="checkbox" name="salaJogos" id="salaJogos"><label for="salaJogos">Salão de jogos</label>
        </div>
        <div class="check-item">
        ...
        <div class="check-item">
            <input type="checkbox" name="estacionamentoVisita" id="estacionamentoVisita"><label for="estacionamentoVisita">Estacionamento para Visitantes</label>
        </div>
        <div class="check-item">
            <input type="checkbox" name="alarme" id="alarme"><label for="alarme">Alarme</label>
        </div>
        <div class="check-item">
            <input type="checkbox" name="sistemaIncendio" id="sistemaIncendio"><label for="sistemaIncendio">Sistema de Incêndio</label>
        </div>
        <div class="check-item">
        ...
        <div class="check-item">
            <input type="checkbox" name="geradorEnergia" id="geradorEnergia"><label for="geradorEnergia">Gerador de energia</label>
        </div>
